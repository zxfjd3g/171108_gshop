      ...
      <transition name="move">
        <div class="shopcart-list" v-show="listShow">
          <div class="list-header">
            ...
            <mt-button style="float: right" type="danger" @click.native="clearCart">清空</mt-button>
          </div>
...
<script>
  ...
  import { MessageBox, Toast } from 'mint-ui'  // 吐司
